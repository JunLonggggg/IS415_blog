...
```{r}
# add table with headers <Data, Format, Description, Source>
```
...
```{r}
sum(is.na(jakarta_sf23845$KAB_KOTA))
```
...
Function for creating standard box map with Quanitle distribution
...
cumu_case_jan_21 = map1(jan_21_covid,"cumulative confirmed cases rate","Cumulative Postive Cases","January 2020")
cumu_case_feb_21 = map1(feb_21_covid,"cumulative confirmed cases rate","Cumulative Postive Cases","February 2020")
cumu_case_mar_21 = map1(mar_21_covid,"cumulative confirmed cases rate","Cumulative Postive Cases","March 2020")
cumu_case_apr_21 = map1(apr_21_covid,"cumulative confirmed cases rate","Cumulative Postive Cases","April 2020")
cumu_case_may_21 = map1(may_21_covid,"cumulative confirmed cases rate","Cumulative Postive Cases","May 2020")
cumu_case_jun_21 = map1(jun_21_covid,"cumulative confirmed cases rate","Cumulative Postive Cases","June 2020")
cumu_case_jul_21 = map1(jul_21_covid,"cumulative confirmed cases rate","Cumulative Postive Cases","July 2020")
cumu_case_aug_21 = map1(aug_21_covid,"cumulative confirmed cases rate","Cumulative Postive Cases","August 2020")
